...
var SGB = /*#__PURE__*/function (_NativeCurrency) {
  _inheritsLoose(SGB, _NativeCurrency);

  function SGB(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'SGB', 'Songbird') || this;
  }

  SGB.onChain = function onChain(chainId) {
    var _this$_cache$chainId;

    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new SGB(chainId);
  };

  var _proto = SGB.prototype;
